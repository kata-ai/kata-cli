...
class Channel {
    ...
    addChannel(channelName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const environmentId = yield this.inquireEnvironmentId();
            try {
    ...
    inquireEnvironmentId() {
        return __awaiter(this, void 0, void 0, function* () {
            const environmentListP = this.listEnvironment();
            const environmentList = yield environmentListP;
            const choices = environmentList.map((row) => ({ name: row.name, value: row.id }));
