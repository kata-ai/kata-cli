...
class Bot extends merapi_1.Component {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!botDesc.id) {
                ...
                try {
                    ...
                    console.log(`BOT CREATED SUCCESSFULLY WITH REVISION ${result.data.revision}`);
                }
                catch (e) {
                ...
                try {
                    ...
                    // desc.revision = result.data.version;
                    console.log(`UPDATED BOT SUCCESSFULLY WITH REVISION ${result.data.revision}`);
                }
                catch (e) {
                    // desc.version = oldVersion;
                    console.log(this.helper.wrapError(e));
     ...
     */
    console(options) {
        let currentSession = (options.session ? options.session : uuid_1.v4());
        let botDesc;
        try {
