    ...
    rollback(version) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { response: { body } } = yield this.helper.toPromise(this.api.deploymentApi, this.api.deploymentApi.projectsProjectIdDeploymentVersionsGet, projectId, { limit: 1000000, page: 1 });
                if (body && body.data) {
