...
class Nlu extends merapi_1.Component {
    ...
    push() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let entities;
            try {
                nlu = yield this.helper.toPromise(this.api.projectApi, this.api.projectApi.projectsProjectIdNluGet, projectId);
                entities = yield this.helper.toPromise(this.api.nluApi, this.api.nluApi.projectsProjectIdNlusNluNameEntitiesGet, projectId, nluDesc.name);
            }
            catch (error) {
                console.log(this.helper.wrapError(error));
                return;
    ...
    train(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const trainResult = yield this.helper.toPromise(this.api.nluApi, this.api.nluApi.projectsProjectIdNluTrainPost, projectId, opts);
