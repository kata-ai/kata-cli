...
class Nlu extends merapi_1.Component {
    ...
    push() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let entities;
            try {
                nlu = yield this.helper.toPromise(this.api.nluApi, this.api.nluApi.nlusNluNameGet, nluDesc.name);
                entities = yield this.helper.toPromise(this.api.nluApi, this.api.nluApi.nlusNluNameEntitiesGet, nluDesc.name);
            }
            catch (error) {
                if (error.status === 400) {
                    try {
