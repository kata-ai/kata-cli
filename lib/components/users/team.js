...
class Team extends merapi_1.Component {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (userInfo && userInfo.id) {
                    ...
                    const { response } = yield this.helper.toPromise(this.api.teamApi, this.api.teamApi.teamsTeamIdUsersUserIdPost, teamInfo.id, userInfo.id, { roleId: role });
                    if (!response.body) {
    ...
    getInfo(username) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestTeamData = yield this.helper.toPromise(this.api.userApi, this.api.userApi.usersUserIdGet, currentLogin);
            let teamInfo;
            ...
            const requestUserData = yield this.helper.toPromise(this.api.userApi, this.api.userApi.usersUserIdGet, username);
            let userInfo;
            ...
            const requestTeamMember = yield this.helper.toPromise(this.api.teamApi, this.api.teamApi.teamsTeamIdUsersGet, teamInfo.id);
            let teamMember;
