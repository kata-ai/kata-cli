...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Zaun.StateTransition();
  });
  ...
  describe('StateTransition', function() {
    it('should create an instance of StateTransition', function() {
      // uncomment below and update the code to test StateTransition
      //var instane = new Zaun.StateTransition();
      //expect(instance).to.be.a(Zaun.StateTransition);
    });
