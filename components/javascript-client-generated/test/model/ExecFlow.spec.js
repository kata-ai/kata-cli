...
(function(root, factory) {
  ...
  describe('ExecFlow', function() {
    it('should create an instance of ExecFlow', function() {
      // uncomment below and update the code to test ExecFlow
      //var instane = new Zaun.ExecFlow();
      //expect(instance).to.be.a(Zaun.ExecFlow);
    });
