...
(function(root, factory) {
  ...
  describe('ExecIntent', function() {
    it('should create an instance of ExecIntent', function() {
      // uncomment below and update the code to test ExecIntent
      //var instane = new Zaun.ExecIntent();
      //expect(instance).to.be.a(Zaun.ExecIntent);
    });
