...
(function(root, factory) {
  ...
  describe('Nlu', function() {
    it('should create an instance of Nlu', function() {
      // uncomment below and update the code to test Nlu
      //var instane = new Zaun.Nlu();
      //expect(instance).to.be.a(Zaun.Nlu);
    });
