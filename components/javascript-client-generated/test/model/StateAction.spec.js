...
(function(root, factory) {
  ...
  describe('StateAction', function() {
    it('should create an instance of StateAction', function() {
      // uncomment below and update the code to test StateAction
      //var instane = new Zaun.StateAction();
      //expect(instance).to.be.a(Zaun.StateAction);
    });
