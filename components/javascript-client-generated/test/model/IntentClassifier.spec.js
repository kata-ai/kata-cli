...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Zaun.IntentClassifier();
  });
  ...
  describe('IntentClassifier', function() {
    it('should create an instance of IntentClassifier', function() {
      // uncomment below and update the code to test IntentClassifier
      //var instane = new Zaun.IntentClassifier();
      //expect(instance).to.be.a(Zaun.IntentClassifier);
    });
