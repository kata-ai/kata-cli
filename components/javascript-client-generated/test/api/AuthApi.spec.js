  ...
  describe('AuthApi', function() {
    ...
    describe('tokensPost', function() {
      it('should call tokensPost successfully', function(done) {
        ...
        //instance.tokensPost(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('tokensTokenIdGet', function() {
      it('should call tokensTokenIdGet successfully', function(done) {
        //uncomment below and update the code to test tokensTokenIdGet
        //instance.tokensTokenIdGet(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
