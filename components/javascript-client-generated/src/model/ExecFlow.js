...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Zaun.ExecFlow = factory(root.Zaun.ApiClient, root.Zaun.Message);
  }
  ...
  /**
   * The ExecFlow model module.
   * @module model/ExecFlow
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ExecFlow</code>.
   * @alias module:model/ExecFlow
   * @class
   */
  ...
  /**
   * Constructs a <code>ExecFlow</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ExecFlow} obj Optional instance to populate.
   * @return {module:model/ExecFlow} The populated <code>ExecFlow</code> instance.
   */
