...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Zaun.Subscription = factory(root.Zaun.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('penaltyPrice')) {
        obj['penaltyPrice'] = ApiClient.convertToType(data['penaltyPrice'], 'String');
      }
      ...
      if (data.hasOwnProperty('exceedCap')) {
        obj['exceedCap'] = ApiClient.convertToType(data['exceedCap'], 'Number');
      }
  ...
  /**
   * @member {String} penaltyPrice
   */
  exports.prototype['penaltyPrice'] = undefined;
  /**
  ...
  /**
   * @member {Number} exceedCap
   */
  exports.prototype['exceedCap'] = undefined;
  /**
