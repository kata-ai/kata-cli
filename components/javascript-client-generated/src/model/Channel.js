...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Zaun.Channel = factory(root.Zaun.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('partnerChannelId')) {
        obj['partnerChannelId'] = ApiClient.convertToType(data['partnerChannelId'], 'String');
      }
  ...
  /**
   * @member {String} partnerChannelId
   */
  exports.prototype['partnerChannelId'] = undefined;
  /**
   * @member {String} token
   */
